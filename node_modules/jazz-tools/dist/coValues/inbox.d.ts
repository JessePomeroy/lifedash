...
import { type Account, CoValue, CoValueOrZodSchema, ID, InstanceOfSchema } from "../internal.js";
...
export declare class Inbox {
    ...
    private constructor();
    subscribe<M extends CoValueOrZodSchema, O extends CoValue | undefined>(Schema: M, callback: (message: InstanceOfSchema<M>, senderAccountID: ID<Account>) => Promise<O | undefined | void>, options?: {
        retries?: number;
    }): () => void;
