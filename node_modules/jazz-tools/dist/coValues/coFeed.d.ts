...
import type { AnonymousJazzAgent, CoValue, CoValueClass, Group, ID, RefsToResolve, RefsToResolveStrict, Resolved, SchemaFor, SubscribeListenerOptions } from "../internal.js";
 ...
 * @category CoValues
 */
export declare class CoFeed<out Item = any> extends CoValueBase implements CoValue {
    /**
     ...
     * @category Creation
     */
    static create<S extends CoFeed>(this: CoValueClass<S>, init: S extends CoFeed<infer Item> ? Item[] : never, options?: {
        owner: Account | Group;
    } | Account | Group): S;
 ...
 * @internal
 */
export declare const CoStreamPerAccountProxyHandler: (innerTarget: CoFeed) => ProxyHandler<{}>;
