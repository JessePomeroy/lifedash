import { AgentSecret, CryptoProvider, Everyone, InviteSecret, LocalNode, Peer, RawAccount, Role, SessionID } from "cojson";
import { AnonymousJazzAgent, type CoMap, type CoValue, CoValueBase, CoValueClass, CoValueOrZodSchema, type Group, ID, InstanceOrPrimitiveOfSchema, Profile, Ref, RefIfCoValue, RefsToResolve, RefsToResolveStrict, Resolved, type Schema, SubscribeListenerOptions, inspect } from "../internal.js";
...
export declare class Account extends CoValueBase implements CoValue {
    ...
    acceptInvite<S extends CoValueOrZodSchema>(valueID: string, inviteSecret: InviteSecret, coValueClass: S): Promise<Resolved<InstanceOrPrimitiveOfSchema<S>, true> | null>;
    /** @private */
