...
import type { AnonymousJazzAgent, CoValue, CoValueClass, Group, ID, RefIfCoValue, RefsToResolve, RefsToResolveStrict, Resolved, Schema, SubscribeListenerOptions } from "../internal.js";
...
export declare class CoMap extends CoValueBase implements CoValue {
    ...
    static Record<Value>(value: Value): {
        new (options: {
             ...
             * @category Content
             **/
            readonly _refs: Simplify<{ [Key in string as NonNullable<any[Key]> extends CoValue ? Key : never]?: RefIfCoValue<any[Key]> | undefined; } & { [Key_1 in string as any[Key_1] extends undefined ? never : any[Key_1] extends CoValue ? Key_1 : never]: RefIfCoValue<any[Key_1]>; }>;
            /** @internal */
            getEditFromRaw(target: CoMap, rawEdit: {
                by: RawAccountID | AgentID;
                tx: CojsonInternalTypes.TransactionID;
            ...
            castAs<S extends CoValueClass | import("zod/v4/core").$ZodType | (import("zod/v4/core").$ZodObject<any, any> & {
                builtin: "Account";
                migration?: (account: any, creationProps?: {
                    name: string;
                }) => void;
            }) | (import("zod/v4/core").$ZodCustom<any, any> & {
                builtin: "FileStream";
            }) | (import("zod/v4/core").$ZodCustom<any, any> & {
                builtin: "CoFeed";
                element: import("zod/v4/core").$ZodType;
            })>(schema: S): S extends CoValueClass ? InstanceType<S> : S extends import("zod/v4/core").$ZodType ? NonNullable<import("../internal.js").InstanceOfSchemaCoValuesNullable<S>> : never;
        };
        /** @internal */
        _schema: any;
        /**
...
export type CoMapInit<Map extends object> = {
    [Key in CoKeys<Map> as undefined extends Map[Key] ? never : Key]: ForceRequiredRef<Map[Key]>;
} & {
