...
export type RefsToResolve<V, DepthLimit extends number = 10, CurrentDepth extends number[] = []> = boolean | (DepthLimit extends CurrentDepth["length"] ? any : V extends Array<infer Item> ? {
    ...
    [Key in CoKeys<V> as NonNullable<V[Key]> extends CoValue ? Key : never]?: RefsToResolve<NonNullable<V[Key]>, DepthLimit, [
        0,
        ...CurrentDepth
    ]>;
} & {
    ...
    $each: RefsToResolve<NonNullable<V[ItemsSym]>, DepthLimit, [
        0,
        ...CurrentDepth
    ]>;
    $onError?: null;
...
export type Resolved<T, R extends RefsToResolve<T> | undefined = true> = DeeplyLoaded<T, R, 10, []>;
...
((NotNull<Item> & DeeplyLoaded<NotNull<Item>, ItemDepth, DepthLimit, [
    0,
    ...CurrentDepth
