...
import { type Account, AnonymousJazzAgent, CoValueOrZodSchema, type Group, Loaded, RefsToResolve, RefsToResolveStrict, ResolveQuery, ResolveQueryStrict, Resolved, SubscriptionScope, inspect } from "../internal.js";
 ...
 */
export declare function createCoValueObservable<S extends CoValueOrZodSchema, const R extends ResolveQuery<S>>(initialValue?: undefined | null): {
    getCurrentValue: () => Loaded<S, R> | null | undefined;
    subscribe: (cls: S, id: string, options: {
        loadAs: Account | AnonymousJazzAgent;
...
export declare function parseCoValueCreateOptions(options: {
    ...
    owner: Account | Group;
    uniqueness: {
        uniqueness: string | number | true | import("cojson").JsonValue[] | readonly import("cojson").JsonValue[] | import("cojson").JsonObject;
    } | undefined;
};
