...
}) & CoMap) | null : S extends AnyCoListSchema<infer T> ? CoList<InstanceOrPrimitiveOfSchemaCoValuesNullable<T>> | null : S extends AnyCoFeedSchema<infer T> ? CoFeed<InstanceOrPrimitiveOfSchemaCoValuesNullable<T>> | null : S extends PlainTextSchema ? CoPlainText | null : S extends RichTextSchema ? CoRichText | null : S extends FileStreamSchema ? FileStream | null : S extends z.core.$ZodOptional<infer Inner> ? InstanceOrPrimitiveOfSchemaCoValuesNullable<Inner> | undefined : S extends z.ZodJSONSchema ? JsonValue : S extends z.core.$ZodUnion<infer Members> ? InstanceOrPrimitiveOfSchemaCoValuesNullable<Members[number]> : S extends z.core.$ZodObject<infer Shape> ? {
