...
export type PlainTextSchema = z.core.$ZodCustom<CoPlainText, unknown> & {
    ...
    subscribe(id: string, options: {
        loadAs: Account | AnonymousJazzAgent;
    }, listener: (value: CoPlainText, unsubscribe: () => void) => void): () => void;
    subscribe(id: string, listener: (value: CoPlainText, unsubscribe: () => void) => void): () => void;
    fromRaw(raw: RawCoPlainText): CoPlainText;
    getCoSchema: () => typeof CoPlainText;
};
//# sourceMappingURL=PlainTextSchema.d.ts.map