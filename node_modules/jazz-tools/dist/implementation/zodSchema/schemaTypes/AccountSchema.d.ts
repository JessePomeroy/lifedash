...
export type AccountSchema<Shape extends {
    ...
    load: <R extends ResolveQuery<AccountSchema<Shape>>>(id: string, options?: {
    ...
    withMigration(migration: (account: Loaded<AccountSchema<Shape>>, creationProps?: {
        name: string;
    }) => void): AccountSchema<Shape>;
...
export type AccountInstanceCoValuesNullable<Shape extends z.core.$ZodLooseShape> = {
