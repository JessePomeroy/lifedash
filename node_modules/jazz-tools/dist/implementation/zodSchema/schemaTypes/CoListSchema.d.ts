...
type CoListInit<T extends z.core.$ZodType> = Array<T extends z.core.$ZodOptional<any> ? InstanceOrPrimitiveOfSchemaCoValuesNullable<T> : NonNullable<InstanceOrPrimitiveOfSchemaCoValuesNullable<T>>>;
...
export type AnyCoListSchema<T extends z.core.$ZodType = z.core.$ZodType> = z.core.$ZodArray<T> & {
    collaborative: true;
};
export type CoListInstance<T extends z.core.$ZodType> = CoList<InstanceOrPrimitiveOfSchema<T>>;
export type CoListInstanceCoValuesNullable<T extends z.core.$ZodType> = CoList<InstanceOrPrimitiveOfSchemaCoValuesNullable<T>>;
export {};
//# sourceMappingURL=CoListSchema.d.ts.map