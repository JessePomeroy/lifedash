...
export declare class Ref<out V extends CoValue> {
    ...
    constructor(id: ID<V>, controlledAccount: Account | AnonymousJazzAgent, schema: RefEncoded<V>, parent: CoValue);
    load(): Promise<V | null>;
    get value(): V | null | undefined;
}
export declare function makeRefs<Keys extends string | number>(parent: CoValue, getIdForKey: (key: Keys) => ID<CoValue> | undefined, getKeysWithIds: () => Keys[], controlledAccount: Account | AnonymousJazzAgent, refSchemaForKey: (key: Keys) => RefEncoded<CoValue>): {
