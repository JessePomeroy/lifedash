...
export function determineValidTransactions(coValue, knownTransactions) {
    ...
    if (coValue.verified.header.ruleset.type === "group") {
        ...
        const groupContent = expectGroup(coValue.node
            .expectCoValueLoaded(coValue.verified.header.ruleset.group, "Determining valid transaction in owned object but its group wasn't loaded")
            .getCurrentContent());
        ...
        throw new Error("Unknown ruleset type " +
            coValue.verified.header.ruleset.type);
    }
}
