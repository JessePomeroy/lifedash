...
import { hotSleep, loadCoValueOrFail, nodeWithRandomAgentAndSessionID, setupTestNode, waitFor, } from "./testUtils.js";
...
test("Can get last tx ID for a key in CoMap", () => {
    ...
    expect(sessionID && accountOrAgentIDfromSessionID(sessionID)).toEqual(node.getCurrentAgent().id);
