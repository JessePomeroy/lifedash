...
import { SyncMessagesLog, getSyncServerConnectedPeer, setupTestNode, } from "./testUtils";
...
describe("LocalNode auth sync", () => {
    ...
    test("authenticate to an existing account after immediately close the creation node", async () => {
        ...
        const { accountID, accountSecret, node: creationNode, } = await LocalNode.withNewlyCreatedAccount({
            creationProps: {
                name: "new-account",
            },
            peersToLoadFrom: [newAccountPeer],
...
//# sourceMappingURL=sync.auth.test.js.map