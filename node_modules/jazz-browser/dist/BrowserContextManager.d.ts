import { Account, AccountClass, AnyAccountSchema, CoValueFromRaw, InMemoryKVStore, InstanceOfSchema, JazzContextManager, SyncConfig } from "jazz-tools";
...
export type JazzContextManagerProps<S extends (AccountClass<Account> & CoValueFromRaw<Account>) | AnyAccountSchema> = {
    guestMode?: boolean;
    sync: SyncConfig;
    onLogOut?: () => void;
    logOutReplacement?: () => void;
    onAnonymousAccountDiscarded?: (anonymousAccount: InstanceOfSchema<S>) => Promise<void>;
...
export declare class JazzBrowserContextManager<S extends (AccountClass<Account> & CoValueFromRaw<Account>) | AnyAccountSchema> extends JazzContextManager<InstanceOfSchema<S>, JazzContextManagerProps<S>> {
    ...
    getNewContext(props: JazzContextManagerProps<S>, authProps?: JazzContextManagerAuthProps): Promise<{
