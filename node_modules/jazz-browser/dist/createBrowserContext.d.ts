...
export declare function createJazzBrowserContext<S extends (AccountClass<Account> & CoValueFromRaw<Account>) | AnyAccountSchema>(options: BrowserContextOptions<S>): Promise<{
