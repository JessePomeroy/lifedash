...
export class SQLiteNodeBase {
    constructor(db, fromLocalNode, toLocalNode, maxBlockingTime) {
    ...
    static create({ db, localNodeName = "local", maxBlockingTime = 500, }) {
        ...
        new SQLiteNodeBase(db, localNodeAsPeer.incoming, localNodeAsPeer.outgoing, maxBlockingTime);
