...
export class StorageManagerSync {
    ...
    async sendContentMessage(coValueRow, contentMessage) {
    ...
    handleLoad(msg) {
        this.sendNewContent(msg).catch((e) => logger.error("Error sending new content", {
            id: msg.id,
            err: e,
        }));
    }
    ...
    sendStateMessage(msg) {
        this.toLocalNode.push(msg).catch((e) => logger.error(`Error sending ${msg.action} state, id ${msg.id}`, {
            err: e,
        }));
    }
}
//# sourceMappingURL=managerSync.js.map